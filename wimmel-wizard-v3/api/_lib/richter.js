...
// GEAENDERT (23.09.2026, Nutzer-Entscheidung "Mundfrage aus dem Stil-Tor herausnehmen: JA"):
// Befund aus den Vergleichsdaten (Register Abschnitt 17): von vier Ablehnungen widersprachen DREI
// der Messung im selben Bild -- das Stil-Tor nannte "sichtbare Muender", wo mouths_of_ten 0, 1
// bzw. 3 gezaehlt hatte. Es raet dort. Muender entscheidet ab jetzt allein die Zaehlung
// (MOUTHS_MAX_OF_TEN in der Wertung, dazu die 8-von-10-Regel in stilbruchMessung()).
// ACHTUNG, ehrlich vermerkt: die "0 Fehlalarme" von 2026-09-21e wurden mit dem ALTEN Wortlaut
// gemessen. Dieser Wortlaut ist NICHT nachgemessen -- die Zahl gilt fuer ihn nicht mehr.
...
const STIL_TOR_FRAGE_A = "Bild 1 ist die STILREFERENZ, Bild 2 ist ein neu erzeugtes Bild. Passt der ZEICHENSTIL der Figuren in Bild 2 zur Referenz? Massgeblich ist nur, wie die MENSCHEN gezeichnet sind: dicke schwarze Kontur, flache Farbflaechen, runde Koepfe, Punktaugen, ein einzelner senkrechter Nasenstrich, keine plastische Schattierung im Gesicht. NICHT massgeblich: Licht und Schatten am Boden, Verlaeufe in Himmel oder Landschaft, Motiv, Kulisse, Farben, Anzahl der Figuren, Tiere -- und ausdruecklich NICHT, ob die Figuren einen Mund haben. Muender werden an anderer Stelle einzeln gezaehlt; lass sie hier vollstaendig ausser Acht und erwaehne sie auch in der Begruendung nicht. Antworte \"nein\" nur bei einem KLAREN Stilbruch: wenn viele Figuren anders gezeichnet sind als in der Referenz -- zum Beispiel fotoartig, plastisch modelliert, im Anime-, Manga- oder glatten 3D-Stil. Einzelne Abweichungen an wenigen Figuren sind noch ein \"ja\". Antworte NUR als JSON: {\"passt\": \"ja\" oder \"nein\", \"begruendung\": \"ein bis zwei Saetze\"}.";
